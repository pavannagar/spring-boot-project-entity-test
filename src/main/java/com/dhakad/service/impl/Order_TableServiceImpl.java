...
public class Order_TableServiceImpl implements Order_TableService{
	...
	public List<Order_Table> getAllOrder() {
		List<Order_Table> order_Tables=(List<Order_Table>) order_TableRepo.findAll();
		return order_Tables;
	}
	...
	public int changeStatus(int orderId, Status status) {
		int n=order_TableRepo.changeStatus(orderId, status);
		return n;
	}

	@Override
	public List<Object[]> getOrderStatus(int orderId) {
		List<Object[]> object=order_TableRepo.getOrderStatus(orderId);
		return object;
	}
